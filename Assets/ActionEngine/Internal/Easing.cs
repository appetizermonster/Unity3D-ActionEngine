// Referenced from: http://robotacid.com/documents/code/Easing.cs
...
namespace ActionEngine.Internal {
	...
	public class Easing {
		...
		public static float BounceEaseInOut (float t, float b, float c, float d) {
			if (t < d / 2)
				return BounceEaseIn(t * 2f, 0, c, d) * 0.5f + b;
			else
				return BounceEaseOut(t * 2f - d, 0, c, d) * 0.5f + c * 0.5f + b;
		}
